...
import (
	...
	_ "myapp/app/controllers/authentication"
	facebookOauth2 "myapp/app/controllers/authentication/facebookOauth2"
	tests "myapp/tests"
...
func Register() {
	...
	revel.RegisterController((*controllers1.AuthApp)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "IndexTest",
				Args: []*revel.MethodArg{ 
	...
	revel.RegisterController((*facebookOauth2.Application)(nil),
		[]*revel.MethodType{
